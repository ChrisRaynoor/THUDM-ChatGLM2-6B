...
def main():
    ...
    # === fastllm specific
    # load fp16 model
    model = AutoModel.from_pretrained(args.model_path_fp16, trust_remote_code=True)
    tokenizer = AutoTokenizer.from_pretrained(args.model_path_fp16, trust_remote_code=True)
    model = model.eval()
    # convert to fastllm
